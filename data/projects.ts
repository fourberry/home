...
export const fbProjects: FbProject[] = [
    {
        id: 'cuckoo',
        client: '쿠쿠',
        title: 'OMS 초기 구축 참여 경험 · 운영 고도화',
        period: '2021 구축 참여(이전 회사) · 현재 운영',
        thumb: '/images/homeSiSm/oms_2.webp',
        overview:
            '현재 포베리 구성원들이 이전 회사인 루트소프트 재직 당시 쿠쿠 주문관리 시스템(OMS)의 초기 구축에 참여했습니다.\n이후 포베리를 설립하고 약 1년 뒤 OMS 운영을 다시 맡아 운영과 고도화를 수행하고 있습니다.',
        seoTitle: '쿠쿠 OMS 구축 참여 경험과 운영 · 고도화',
        seoDescription: '포베리 구성원의 루트소프트 재직 당시 쿠쿠 OMS 초기 구축 참여 경험과 포베리의 운영 사례입니다. 포베리 설립 약 1년 뒤 운영을 다시 맡아 운영과 고도화를 수행하고 있습니다.',
        category: '구성원 구축 경험 · SM 운영',
        background:
            '2021년 초기 구축은 현재 포베리 구성원들이 루트소프트에 재직하던 당시의 참여 경력입니다. 해당 구성원들은 루트소프트를 나온 뒤 2023년 포베리를 설립했고, 설립 약 1년 뒤 쿠쿠 OMS 운영을 다시 맡았습니다. 초기 구축 참여는 구성원의 이전 경력으로, 운영 재개 이후의 업무는 포베리의 수행 범위로 구분합니다. 초기 구축에서 얻은 시스템 이해를 바탕으로 현재 운영과 기능 고도화를 수행하고 있습니다.',
        scope: ['구성원 이전 경력: 루트소프트 재직 당시 OMS 초기 구축 참여', '포베리 수행: 회사 설립 약 1년 뒤 OMS 운영 재개', '포베리 수행: 시스템 운영(SM) 및 기능 고도화'],
